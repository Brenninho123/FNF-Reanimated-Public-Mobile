...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Char Based Cam Follow Pos', "Just like Camera Follow Pos, \nbut using Character Camera offsets too.\n\nValue 1: X\nValue 2: Y\n\nThe camera won't change the follow point\nafter using this, for getting it back\nto normal, leave both values blank."],
	...
	**/
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('chartingState/portada_2'));
