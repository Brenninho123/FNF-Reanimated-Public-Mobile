...
typedef CharacterFile = {
	...
	var noteAssets:String;
	var notePath:String;
	var noteSplashes:String;
	var strumCovers:String;
}
...
class Character extends FlxSprite
{
	...
	**/
	...
	public var noteAssets:String = '';
	public var notePath:String = '';
	public var noteSplashes:String = '';
	public var strumCovers:String = '';
	...
	public function loadCharacterFile(json:Dynamic)
	{
		...
		// Torch - This is for custom Note Styles per character
		if (json.noteAssets != null && json.noteAssets != '')
			noteAssets = json.noteAssets;
		else if (curCharacter.endsWith("-pixel") || curCharacter == "senpai" || curCharacter == "senpai-angry" || curCharacter == "spirit") 
			noteAssets = 'pixelUI/normal';
		else
			noteAssets = 'normal';
		...
		if (json.noteSplashes != null && json.noteSplashes !=  '')
			noteSplashes = json.noteSplashes;
		/*
		else if (curCharacter.endsWith("-pixel") || curCharacter == "senpai" || curCharacter == "senpai-angry" || curCharacter == "spirit") 
			noteSplashes = 'pixelUI/normal';
		*/ // Don't need this as NoteSplash.hx automatically makes certain noteSplashes pixelated on certain songs/characters
		else 
			noteSplashes = 'normal';

		if (json.strumCovers != null && json.strumCovers != '') {
			strumCovers = json.strumCovers;
		} else {
			strumCovers = 'normal';
		}
